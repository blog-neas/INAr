...
#'
#' @description This data contain a time series expressing the weekly counts of
#' new infections in Germany (period 2002–2008).
#'
#' @docType data
#'
...
#' @references Example 5.1.7, Weiß, C. H. (2018). An introduction to
#' discrete-valued time series. John Wiley & Sons.
#'
